      ...
      {(formik) => (
        <Form className="basic-info-container">
          ...
          <div className="basic-info-container__images">
            <img src={avatar1} onClick={() => handleAvatarClick(1)} className={`${selectedAvatar === 1 ? "activated" : ''}`}/>
            <img src={avatar2} onClick={() => handleAvatarClick(2)} className={`${selectedAvatar === 2 ? "activated" : ''}`}/>
            <img src={avatar3} onClick={() => handleAvatarClick(3)} className={`${selectedAvatar === 3 ? "activated" : ''}`}/>
            <img src={avatar4} onClick={() => handleAvatarClick(4)} className={`${selectedAvatar === 4 ? "activated" : ''}`}/>
          </div>
          <TextField
            name="name"
